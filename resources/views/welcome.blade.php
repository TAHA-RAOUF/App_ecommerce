...
<head>
    ...
    <!-- For favicon png -->
    <link rel="shortcut icon" type="image/icon" href="{{ Vite::asset('resources/logo/favicon.png') }}"/>

    <!-- Import CSS files via Vite -->
    @vite([
									...
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
                                                ...
                                                <img src="{{ asset('images/slider/slider1.png') }}" alt="slider image">
                                                </div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
								...
								<div class="welcome-hero-content">
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
                                                <img src="{{ asset('images/slider/slider2.png') }}" alt="slider image">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
								...
								<div class="welcome-hero-content">
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
                                                <img src="{{ asset('images/slider/slider3.png') }}" alt="slider image">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
				        ...
				        <div class="container">            
				            ...
				            <div class="attr-nav">
				                <ul>
									...
									<li class="nav-profil">
    									<a href="{{ route('register') }}"><span class="fa fa-user"></span></a>
									</li>
									<li class="nav-profil">
										@if(Auth::check())
											<a href="{{ route('user.commands', ['id' => Auth::user()->id]) }}">
												<span class="lnr lnr-cart"></span> <!-- Icône de panier -->
											</a>
										@else
											<a href="{{ route('login') }}">
												<span class="lnr lnr-cart"></span> <!-- Icône de panier -->
				            ...
				            <div class="navbar-header">
				                ...
				                <a class="navbar-brand" href="#">furn.</a>
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-product-img mt40">
									<img src="images/populer-products/p1.png" alt="populer-products images">
								</div>
									...
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img">
												<img src="images/populer-products/p2.png" alt="populer-products images">
											</div>
										</div>
							...
							<div class="single-populer-products">
								<div class="single-populer-products">
									<div class="single-populer-product-img">
										<img src="images/populer-products/p3.png" alt="populer-products images">
									</div>
    ...
    <div class="container">
        ...
        <div class="new-arrivals-content">
            <div class="row">
                <!-- Liste des produits -->
                @foreach ([
                    ['id' => 1, 'name' => 'Wooden Chair', 'price' => 65.00, 'image' => 'images/collection/arrivals1.png'],
                    ['id' => 2, 'name' => 'Single Armchair', 'price' => 80.00, 'image' => 'images/collection/arrivals2.png'],
                    ['id' => 3, 'name' => 'Wooden Armchair', 'price' => 40.00, 'image' => 'images/collection/arrivals3.png'],
                    ['id' => 4, 'name' => 'Stylish Chair', 'price' => 100.00, 'image' => 'images/collection/arrivals4.png'],
                    ['id' => 5, 'name' => 'Modern Chair', 'price' => 120.00, 'image' => 'images/collection/arrivals5.png'],
                    ['id' => 6, 'name' => 'Maple Wood Dining Table', 'price' => 140.00, 'image' => 'images/collection/arrivals6.png'],
                    ['id' => 7, 'name' => 'Arm Chair', 'price' => 90.00, 'image' => 'images/collection/arrivals7.png'],
                    ['id' => 8, 'name' => 'Wooden Bed', 'price' => 140.00, 'image' => 'images/collection/arrivals8.png']
                ] as $product)
                            ...
                            <div class="single-new-arrival-bg">
                                ...
                                <div class="new-arrival-cart">
                                    <p>
                                        ...
                                        <a href="#" class="add-to-cart" data-id="{{ $product['id'] }}" data-name="{{ $product['name'] }}" data-price="{{ $product['price'] }}">Add <span>to</span> cart</a>
                                    </p>
		...
		<footer id="footer"  class="footer">
			<div class="container">
				<div class="hm-footer-copyright text-center">
					...
					<p>
						&copy;copyright. designed and developed by <a href="#">tarik elatifi</a>
					</p><!--/p-->
				</div><!--/.text-center-->
			</div><!--/.container-->
...
<script>
    ...
    $('.add-to-cart').on('click', function(e) {
        ...
        var product_id = $(this).data('id'); // Assurez-vous que cet attribut existe dans votre HTML
        var user_id = 1; // Remplacez par l'ID de l'utilisateur connecté, si disponible
        var quantity = 1; // Remplacez par la quantité désirée

        console.log('Tentative d\'ajout au panier pour le produit ID:', product_id);

        $.ajax({
            url: '{{ route("commands.store") }}', // Utilisez le nom de la route ici
            type: 'POST',
            data: {
                product_id: product_id,
                user_id: user_id,
                quantity: quantity,
				_token: $('meta[name="csrf-token"]').attr('content') // Assurez-vous que cette ligne est présente
            },
            success: function(response) {
                alert(response.message); // Affiche le message de succès
            },
            error: function(xhr) {
                console.log(xhr.responseText); // Affiche la réponse complète pour débogage
                const errors = xhr.responseJSON.errors;
                if (errors) {
                    alert(errors.product_id ? errors.product_id[0] : 'Erreur lors de l\'ajout de la commande');
                } else {
